...
import './SkeletonEditModalProfile.css';
...
function SkeletonEditModalProfile ({skellie, handleModalClose, handleSkellieUpdate}) {
      ...
      <>  
        ...
        <div className='edit-modal-profile' id="edit-skeleton-form">
          ...
          <form className="edit-modal-form-profile" onSubmit={skeletonSubmit}>
            ...
            <label>
              <span className='edit-skellie-label-profile'>
                <h2 className='edit-skellie-label-text-profile'>
                  Title:
                </h2>
              </span>
              <br/>
              <input type="text"
                ...
                placeholder="Title"
                className='edit-skellie-input-profile'
              />
            </label>
            ...
            <Multiselect
              ...
              id="edit-collaborator-select-profile"
              />
            ...
            <input
              ...
              className='skellie-form-submit-button-profile'
              id="edit-skellie-submit-button-profile"
              type="submit"
              value="Save Changes"
...
export default SkeletonEditModalProfile;